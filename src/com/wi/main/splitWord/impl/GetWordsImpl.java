package com.wi.main.splitWord.impl;

import static com.wi.main.library.InitDictionary.arrayLength;
import static com.wi.main.library.InitDictionary.base;
import static com.wi.main.library.InitDictionary.check;
import static com.wi.main.library.InitDictionary.status;
import static com.wi.main.library.InitDictionary.termNatures;
import static com.wi.main.library.InitDictionary.words;

import com.wi.main.domain.TermNatures;
import com.wi.main.splitWord.GetWords;
...
public class GetWordsImpl implements GetWords {
	...
	private int getStatement() {
		...
		if (baseValue < arrayLength
				&& (check[baseValue] == checkValue || check[baseValue] == -1)) {
